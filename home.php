...
<section class="home-about">
   ...
   <div class="content">
      <h3>about us</h3>
      <p>Amazing Tours a Best tour Operator and Travel agent . We are Tour Package, Hotel booking.  Tours & Travel agent. Find international and domestic tour packages from  at low prices including best ... Travel Package| Tour Package</p>
...
<section class="home-offer home-packages">
   ...
   <div class="content">
      <h3>upto 40% off</h3>
      <p>Bali Dynasty Resort is centrally located within walking distance to the nightlife and excitement of the Kuta area. This popular Bali accommodation offers a wide range of room types to suit families. The kids can enjoy the kids club while the adults spoil themselves at Ashoka Spa or the Beach Club. For a memorable and relaxing stay in Kuta why not stay at Bali Dynasty Resort.</p>
      <a href="book.php" class="btn">book now</a>
   </div>
</section>
...
<section class="footer">
   ...
   <div class="credit"> designed by <span>a group</span></div>
</section>
<!-- footer section ends -->
<!-- swiper js link  -->
